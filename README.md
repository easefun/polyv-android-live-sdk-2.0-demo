...
[![GitHub release](https://img.shields.io/badge/release-v2.5.5-blue.svg)](https://github.com/easefun/polyv-android-live-sdk-2.0-demo/releases/tag/v2.5.5)
...
2.5.5版API文档请看[v2.5.5 API](http://repo.polyv.net/android/live/sdk/2.5.5/api/index.html)。
