...
[![GitHub release](https://img.shields.io/badge/release-v2.6.0-blue.svg)](https://github.com/easefun/polyv-android-live-sdk-2.0-demo/releases/tag/v2.6.0)
...
2.6.0版API文档请看[v2.6.0 API](http://repo.polyv.net/android/live/sdk/2.6.0/api/index.html)。
