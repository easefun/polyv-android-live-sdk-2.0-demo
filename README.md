...
[![GitHub release](https://img.shields.io/badge/release-v2.6.1-blue.svg)](https://github.com/easefun/polyv-android-live-sdk-2.0-demo/releases/tag/v2.6.1)
...
2.6.1版API文档请看[v2.6.1 API](http://repo.polyv.net/android/live/sdk/2.6.1/api/index.html)。
