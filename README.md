...
[![GitHub release](https://img.shields.io/badge/release-v2.6.2-blue.svg)](https://github.com/easefun/polyv-android-live-sdk-2.0-demo/releases/tag/v2.6.2)
...
2.6.2版API文档请看[v2.6.2 API](http://repo.polyv.net/android/live/sdk/2.6.2/api/index.html)。
