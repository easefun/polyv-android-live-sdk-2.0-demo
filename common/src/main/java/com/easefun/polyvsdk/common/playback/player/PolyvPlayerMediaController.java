package com.easefun.polyvsdk.common.playback.player;
...
import com.easefun.polyvsdk.common.playback.util.PolyvShareUtils;
...
public class PolyvPlayerMediaController extends PolyvBaseMediaController implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.iv_dmswitch || i == R.id.iv_dmswitch_port) {
            resetDmSwitchView();
