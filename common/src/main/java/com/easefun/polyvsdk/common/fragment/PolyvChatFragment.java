package com.easefun.polyvsdk.common.fragment;
...
import com.easefun.polyvsdk.common.util.PolyvFaceManager;
import com.easefun.polyvsdk.common.util.PolyvKickAssist;
import com.easefun.polyvsdk.common.adapter.PolyvChatAdapter;
import com.easefun.polyvsdk.common.adapter.PolyvChatAdapter.OnItemClickListener;
import com.easefun.polyvsdk.common.adapter.PolyvEmoGridViewAdapter;
import com.easefun.polyvsdk.common.adapter.PolyvEmoPagerAdapter;
...
import com.easefun.polyvsdk.common.view.PolyvLikeIconView;
...
//                                chatMessage.setValues(new CharSequence[]{span3});
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.iv_page1) {
            vp_emo.setCurrentItem(0);

        } else if (i == R.id.iv_page2) {
            vp_emo.setCurrentItem(1);

        } else if (i == R.id.iv_page3) {
            vp_emo.setCurrentItem(2);

        } else if (i == R.id.iv_page4) {
            vp_emo.setCurrentItem(3);

        } else if (i == R.id.iv_page5) {
            vp_emo.setCurrentItem(4);

        } else if (i == R.id.iv_emoswitch) {
            resetEmoLayout(false);

        } else if (i == R.id.et_talk) {
            resetEmoLayout(true);

        } else if (i == R.id.tv_loadmore) {
