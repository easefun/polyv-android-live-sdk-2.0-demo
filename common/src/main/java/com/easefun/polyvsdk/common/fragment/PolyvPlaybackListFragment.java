...
import com.easefun.polyvsdk.common.adapter.AbsRecyclerViewAdapter;
import com.easefun.polyvsdk.common.adapter.EndlessRecyclerOnScrollListener;
import com.easefun.polyvsdk.common.adapter.HeaderViewRecyclerAdapter;
import com.easefun.polyvsdk.common.adapter.PolyvPlaybackListAdapter;
...
public class PolyvPlaybackListFragment extends Fragment {
    ...
    private void loadPlaybackList(boolean isShowProgressBar) {
        ...
        liveRecordFiles.getRecordFiles(PolyvConstant.appId, PolyvConstant.appSecret,
